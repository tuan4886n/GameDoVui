...
function startGame() {
    ...
    fetch("http://192.168.1.19:8080/start_game", {
        method: "POST",
...
function loadQuiz() {
    ...
    fetch("http://192.168.1.19:8080/quiz")
    .then(response => response.json())
    .then(data => {
...
function submitAnswer(questionId, isCorrect) {
    ...
    fetch("http://192.168.1.19:8080/submit_score", {
        method: "POST",
        headers: {
...
function fetchLeaderboard(page = 1) {
    ...
    fetch(`http://192.168.1.19:8080/leaderboard?page=${page}`)
    .then(response => {
